<?php
require_once 'model/model_ciudades.php';
require_once 'model/model_paises.php';
$pagina = 'Ciudades';

$resultado = obtenerCiudades($conexion);
$resultPais = obtenerPaises($conexion);
...
require_once 'vistas/ciudades.html.php';